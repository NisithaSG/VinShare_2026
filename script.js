...
async function checkUser() {
    ...
    if (user) {
        // when user is logger in
        authBtn.innerText = "Sign Out";
        
        // Show the Profile and Notification buttons
        if (profileBtn) profileBtn.style.display = 'flex';
        if (notifWrapper) notifWrapper.style.display = 'flex';

        // Setup the anonymous name
        ...
        // the click behavior to Sign Out
        authBtn.onclick = async () => {
            await db.auth.signOut();
            window.location.reload(); // Hard refresh to reset all states
        };

    } else {
        // when user is logger out
        authBtn.innerText = "Sign In";
        
        // Hide the Profile and Notification buttons
        ...
        // the click behavior to Open Modal
